...
import { ChevronDown, Plus, Trash2, Upload, Search, Play } from "lucide-react";
            ...
            {isExpanded && (
              <div className="mt-2 ml-3 pl-3 border-l-2 border-green-300 py-2 space-y-2">
                ...
                {tool.id === "documents" && (
                  <div className="space-y-2">
                    <p className="text-xs text-gray-600">{tool.description}</p>
                    <label className="flex items-center gap-2 px-2 py-1 bg-green-600 hover:bg-green-700 text-white text-xs rounded cursor-pointer">
                ...
                {tool.id === "code" && (
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500 font-mono"
                      rows={4}
                    />
                    <Button
